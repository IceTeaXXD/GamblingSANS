...
g++ main.cpp ../bin/DeckCard.o ../bin/AbilityCard.o ../bin/Abilities.o ../bin/CardCollection.o ../bin/GameManager.o ../bin/Player.o ../bin/ArrOfPlayer.o ../bin/FindValue.o ../bin/Kombinasi.o ../bin/Warna.o ../bin/Angka.o
test&cls
a.exe